...
//	}
	...
	@Override
	public void updateCustomer(int customerLoginId) {
	...
	public void deleteCustomer(int id) {
		...
		orderDaoImpl.viewAllOrder(id);
		if(OrderDaoImpl.customerOrderList.size() != 0)
		{
			for (Order order : OrderDaoImpl.customerOrderList) {
	...
	@Override
	public int isCustomerAccount(String customer_email) {
		Session session = HibernetUtil.getSessionFactory().openSession();
		Transaction transaction = null;
