...
import com.project.dao.MenuItemDao;
...
public class MenuItemDaoImpl implements MenuItemDao{
	...
	public MenuItemDaoImpl(int choice) {
		getMenuItem();
		switch (choice) {
		case 1:
			addMenuItem();
...
//	}
	...
	public void addMenuItem() {
		menuCatagoryDaoImpl.getMenuCatagory();
		if (MenuCatagoryDaoImpl.menu_catagory_list.size() == 0) {
			System.out.println("No catagory exists");
		}
		menutypeDaoImpl.getMenuType();
		if (MenuTypeDaoImpl.menu_type_list.size() == 0) {
			System.out.println("No type exists");
		} else {
			System.out.println("ADD MENU ITEM");
			System.out.println("-----------------------------------");
			menuCatagoryDaoImpl.showMenuCatagory();
			System.out.println("Enter catagory ID: ");
			int catagory = sn.nextInt();

			menutypeDaoImpl.showMenuType();
...
//				getMenuItem();
	...
	@Override
	public void showAvailableMenuItem() {
		Session session = HibernetUtil.getSessionFactory().openSession();
		try {
